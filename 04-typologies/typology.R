...
data = readRDS("small_dataset.rds")
# data = read.xlsx("small_dataset.xlsx", sheet = 1)
...
# DELINEATION AND INTERPRETATION OF FARM TYPES----------------------------------
...
## Principal coordinate analysis & hierarchical cluster analysis
...
data = merge(data, typo[, c(1, 41)], by = "ID")
...
## Most representative farm of each type
